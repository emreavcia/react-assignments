...
const PersonList = ({ employees, getData, URL, form }) => {
    ...
    const handleModelDetail = (id) => {
        setEmployeeDetail({ ...employeeDetail, ...employees.find(employee => employee.id === id) })
    }
                                    ...
                                    <tr key={employee.id}>
                                        ...
                                        <td>
                                            <BsEyeFill
                                                ...
                                                role="button"
                                                style={{ color: "blue", marginRight: "10px", fontSize: "24px" }}
                                                onClick={() => handleModelDetail(employee.id)}
                                            />
                                            <HiPencil
                                                data-bs-toggle="modal"
